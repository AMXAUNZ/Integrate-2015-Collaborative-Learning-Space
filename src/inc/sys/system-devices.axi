...
dvTpLecturnMain = DEVICE_ID_PANEL_LECTURN:1:SYSTEM_NUMBER_THIS

// 10" Touch Panel on Student Table
dvTpStudentMain = DEVICE_ID_PANEL_STUDENT:1:SYSTEM_NUMBER_THIS

// 7" Scheduling Touch Panel
dvTpSchedulingMain = DEVICE_ID_PANEL_SCHEDULING:1:SYSTEM_NUMBER_THIS
